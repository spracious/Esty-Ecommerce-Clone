      ...
      <div className="product1">
        ...
        <div className="product1-B-main">
          ...
          <div className="product1-B-main-3">
            ...
            <p className="product1-B-main-3-price">USD 3.15</p>
            ...
            <p>
              <button className="product1-B-btn">Add to cart</button>
            </p>
            ...
            <p
              style={{ marginTop: "18px", fontSize: "14px", textAlign: "left" }}
            >
              1947 GENUINE COIN FROM KING GEORGE VI
            </p>

            <p
              style={{ marginTop: "40px", fontSize: "16px", textAlign: "left" }}
            >
            ...
            <p
              style={{ marginTop: "20px", textAlign: "left", fontSize: "24px" }}
            >
              Feb 18-Mar 4
            </p>
            ...
            <p
              style={{ marginTop: "30px", textAlign: "left", fontSize: "12px" }}
            >
              Cost to ship
            </p>
            <p
              style={{ marginTop: "10px", textAlign: "left", fontSize: "26px" }}
            >
              USD 5.05
            </p>
            ...
            >
              Esty offsets carbon emissions from shipping and packaging on this
              purchase
            </p>
            ...
            >
              ...
              <p>
                Shop confidently on Etsy <br /> knowing if something goes wrong
